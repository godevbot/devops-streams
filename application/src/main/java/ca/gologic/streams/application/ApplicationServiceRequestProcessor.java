...
public class ApplicationServiceRequestProcessor implements StreamProcessorThread {
	private static Logger LOG = LoggerFactory.getLogger(ApplicationServiceRequestProcessor.class);
